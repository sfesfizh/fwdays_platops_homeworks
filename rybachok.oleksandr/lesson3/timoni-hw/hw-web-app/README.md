...
A [timoni.sh](http://timoni.sh) module for deploying hw-web-app to Kubernetes clusters.
...
```shell
timoni -n default apply hw-web-app oci://<container-registry-url>
```
...
```shell
timoni -n default delete hw-web-app
```
